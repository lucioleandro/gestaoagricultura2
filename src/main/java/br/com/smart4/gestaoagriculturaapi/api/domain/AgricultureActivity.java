...
//  =========================================== CAMPOS PARTICULARES DA CLASSE
	...
	private br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumIrrigationMethod metodoIrrigacao;
	
	@Enumerated(EnumType.STRING)
	private br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumWaterSource fonteAgua;
//  =========================================== RELACIONAMENTOS
...
//  ===========================================
	...
	public AgricultureActivity(Long id, int version, LocalDate dataPlantio, String variedade, double areaPlantada,
							   Integer quantidadePlantas, double producaoAnual, br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumIrrigationMethod metodoIrrigacao,
							   br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumWaterSource fonteAgua, Property property, Product product) {
		this.id = id;
	...
	public AgricultureActivity(Product product, LocalDate dataPlantio, String variedade, double areaPlantada,
							   Integer quantidadePlantas, double producaoAnual, br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumIrrigationMethod metodoIrrigacao,
							   br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumWaterSource fonteAgua, Property property) {
		this.product = product;
		this.dataPlantio = dataPlantio;
		this.variedade = variedade;
		this.areaPlantada = areaPlantada;
	...
	public br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumIrrigationMethod getMetodoIrrigacao() {
		return metodoIrrigacao;
	}

	public br.com.smart4.gestaoagriculturaapi.api.domain.enums.EnumWaterSource getFonteAgua() {
		return fonteAgua;
	}
