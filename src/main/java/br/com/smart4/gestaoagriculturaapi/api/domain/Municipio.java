...
@Entity
@Table(name = "agri_municipio", schema = "agricultuta")
public class Municipio implements Serializable {
	...
	public Municipio(Long id, int version, String nome, Integer cadastroUnico, String uf) {
		this.id = id;
	...
	public Municipio(String nome, Integer cadastroUnico, String uf) {
		this.nome = nome;
		this.cadastroUnico = cadastroUnico;
		this.uf = uf;
	}
